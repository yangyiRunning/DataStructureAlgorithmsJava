...
public class ArraySerialize {
    ...
    public static void main(String[] args) {
        ...
        ArraySerialize arraySerialize = new ArraySerialize();
        String result = arraySerialize.store(objects);
        ...
        Object[] objectsResult = arraySerialize.load(result);
        System.out.println(Arrays.toString(objectsResult));
        System.out.println();
        System.out.println("------------优雅的分割线-------------");
        System.out.println();
        System.out.println("再将反序列化得出来的数组原路序列化回去，用equals比较一下");
        String resultFinal = arraySerialize.store(objectsResult);
